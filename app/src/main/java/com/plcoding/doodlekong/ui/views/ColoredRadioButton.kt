...
class ColoredRadioButton @JvmOverloads constructor(
    context: Context,
    ...
    init {
        context.theme.obtainStyledAttributes(attrs, R.styleable.ColoredRadioButton, 0, 0).apply {
            try {
                buttonColor = getColor(R.styleable.ColoredRadioButton_buttonColor, Color.BLACK)
            } finally {
                recycle()
            }
        }
